...
I work in the IT realm and have been tracking AI since before it became a big deal. I don't say that as a brag for me, but mostly to point out that it's nothing new! The algorithms for AI have literally been around since before computers were invented but the issue with it was that we couldn't run it fast and large enough to make it useful until recently! We have made advances to AI training but the basic algorithms were around before computers and are still used! The main roadblock was not that we didn't know how to do it, but that we couldn't do it fast enough and iterate over it quickly enough to be of much use! 
